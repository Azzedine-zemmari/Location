...
$reservations = $class->getAllReservation();
                            ...
                            <table class="min-w-full">
                                <thead>
                                    <tr class="border-b">
                                        ...
                                        <th class="text-left p-3">vehicule</th>
                                        <th class="text-left p-3">lieu</th>
                                        <th class="text-left p-3">date_Debut</th>
                                        <th class="text-left p-3">date_fin</th>
                                ...
                                <tbody>
                                    <?php foreach ($reservations as $reservation): ?>
                                        <tr class="border-b">
                                            ...
                                            <td class="p-3"><?= $reservation['mark'] ?></td>
                                            <td class="p-3"><?= $reservation['lieuName'] ?></td>
                                            <td class="p-3"><?= $reservation['date_debut'] ?></td>
                                            <td class="p-3"><?= $reservation['date_fin'] ?></td>
                                            <td class="p-3"><?= $reservation['status'] ?></td>
                                            <td class="p-3">
                                                <a href="./acceptReserve.php?id=<?=$reservation['id'] ?>">accepter</a>
                                                <a href="./refuserRserve.php?id=<?=$reservation['id'] ?>">refuser</a>
                                            </td>  
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
